...
predictive_canon(pri, G::IncompleteFormulation, x) = predictive_canon(pri, suffstats(G, x))
predictive_canon(pri, G::IncompleteFormulation, x, w) = predictive_canon(pri, suffstats(G, x, w))
...
predictive(pri::P, ss::SufficientStats) where {P<:Distribution} = Base.convert(P, predictive_canon(pri, ss))
predictive(pri::P, G::IncompleteFormulation, x) where {P<:Distribution} = Base.convert(P, predictive_canon(pri, G, x))
predictive(pri::P, G::IncompleteFormulation, x, w) where {P<:Distribution} = Base.convert(P, predictive_canon(pri, G, x, w))
...
predictive_rand(pri, ss::SufficientStats) = Base.rand(predictive_canon(pri, ss))
predictive_rand(pri, G::IncompleteFormulation, x) = Base.rand(predictive_canon(pri, G, x))
predictive_rand(pri, G::IncompleteFormulation, x, w) = Base.rand(predictive_canon(pri, G, x, w))

predictive_rand!(r::Array, pri, ss::SufficientStats) = Base.rand!(predictive_canon(pri, ss), r)
predictive_rand!(r::Array, pri, G::IncompleteFormulation, x) = Base.rand!(predictive_canon(pri, G, x), r)
predictive_rand!(r::Array, pri, G::IncompleteFormulation, x, w) = Base.rand!(predictive_canon(pri, G, x, w), r)
...
predictive_mode(pri, ss::SufficientStats) = Distributions.mode(predictive_canon(pri, ss))
predictive_mode(pri, G::IncompleteFormulation, x) = Distributions.mode(predictive_canon(pri, G, x))
predictive_mode(pri, G::IncompleteFormulation, x, w) = Distributions.mode(predictive_canon(pri, G, x, w))
...
predictive_randmodel(pri, G::IncompleteFormulation, x) = complete(G, pri, predictive_rand(pri, G, x))
predictive_randmodel(pri, G::IncompleteFormulation, x, w) = complete(G, pri, predictive_rand(pri, G, x, w))
